...
class TaskProvider with ChangeNotifier {
    ...
    if (response['data'] != null) {
      for (int i = 0; i < response['data'].length; i++) {
        loadedItem.add(Task(
            ...
            image: await fetchImage(prefs.getString('username'),
  ...
  Future<void> deleteItem(
      String idItem, String username, String filename) async {
    ...
    notifyListeners();
    final url =
        'http://192.168.0.107:5000/deleteItem/$username/$idItem/$filename';
    final response =
